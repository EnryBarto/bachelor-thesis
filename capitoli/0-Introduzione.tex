...
Un event display è un software grafico che permette di visualizzare i segnali letti dai sensori all'interno del rivelatore.
Il software attuale è però affetto da alcune significative limitazioni: mette innanzitutto a disposizione solo due viste fisse, ovvero le proiezioni bidimensionali laterali e dall'alto del rivelatore, impedendo qualsiasi interazione con la geometria.
